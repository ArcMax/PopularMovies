...
public class MoviesProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "com.explore.archana.nanoproject.provider";
    ...
    public MoviesSQLiteOpenHelper sqLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        sqLiteOpenHelper = new MoviesSQLiteOpenHelper(context);
