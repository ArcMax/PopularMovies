...
public class MovieTrailersResult implements Parcelable {
    ...
    public static final Parcelable.Creator<MovieTrailersResult> CREATOR = new Creator<MovieTrailersResult>() {
        @Override
        public MovieTrailersResult createFromParcel(Parcel source) {
            MovieTrailersResult result = new MovieTrailersResult();
            result.name = source.readString();
            result.key = source.readString();
            return result;
        }
